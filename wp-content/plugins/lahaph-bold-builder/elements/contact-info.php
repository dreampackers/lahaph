...
function lahaph_bb_register_contact_info(): void {
	...
	bt_bb_add_shortcode(
		...
		[
			[
				...
				'title' => '주소',
				'type'  => 'textarea',
				'value' => '서울특별시 마포구 서교동 408-18 스페이스빌딩 5층',
			],
			[
				'name'  => 'phone',
				'title' => '전화번호',
			...
			[
				...
				'type'  => 'textarea',
				'value' => '',
				'help'  => '예: 월~금 10:00 – 18:00',
			],
			[
				'name'  => 'youtube_url',
				'title' => 'YouTube URL',
				'type'  => 'text',
				'value' => 'https://www.youtube.com/channel/UCpkCPxWdDI18VV6JGLGTKJw',
			],
			[
				'name'  => 'blog_url',
				'title' => '블로그 URL',
				'type'  => 'text',
				'value' => 'https://blog.naver.com/musicaln',
			],
			[
				'name'  => 'show_map',
				'title' => '지도 표시',
			...
			[
				...
				'type'  => 'text',
				'value' => '',
				'help'  => '카카오맵 또는 구글맵 iframe src URL (show_map이 "표시"일 때 사용)',
			],
			[
				'name'  => 'layout',
				'title' => '레이아웃',
				...
				'value' => 'vertical',
				'values' => [
					[ 'name' => '세로형',   'value' => 'vertical' ],
					[ 'name' => '가로형 (지도+정보)', 'value' => 'horizontal' ],
				],
			],
		],
		'라하프 연락처, 주소, SNS 링크를 출력합니다.'
	);
}
