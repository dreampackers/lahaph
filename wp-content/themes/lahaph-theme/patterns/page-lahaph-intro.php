...
/**
 * Title: 라하프 소개 페이지
 * Slug: lahaph-theme/page-lahaph-intro
 * Categories: lahaph
 * Description: Lahaph > 소개 페이지 전체 콘텐츠
 * Viewport Width: 1200
 * Inserter: true
 */
?>
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group lahaph-card" style="background-color:#FFFFFF;border-radius:8px;border-left:4px solid var(--wp--preset--color--primary-green);padding:var(--wp--preset--spacing--30)">
				...
				<p style="color:#555555">발달장애 배우들이 직접 무대에 서는 창작 뮤지컬을 기획·제작하고 공연합니다.</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group lahaph-card" style="background-color:#FFFFFF;border-radius:8px;border-left:4px solid var(--wp--preset--color--primary-green);padding:var(--wp--preset--spacing--30)">
				...
				<!-- /wp:heading -->
				<!-- wp:paragraph {"style":{"color":{"text":"#555555"}}} -->
				<p style="color:#555555">각 개인의 특성과 강점에 맞는 예술교육 프로그램을 개발하고 운영합니다.</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group lahaph-card" style="background-color:#FFFFFF;border-radius:8px;border-left:4px solid var(--wp--preset--color--primary-green);padding:var(--wp--preset--spacing--30)">
				...
				<!-- /wp:heading -->
				<!-- wp:paragraph {"style":{"color":{"text":"#555555"}}} -->
				<p style="color:#555555">예술 활동을 바탕으로 발달장애인이 직업인으로 성장할 수 있는 경로를 만들어갑니다.</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group lahaph-card" style="background-color:#FFFFFF;border-radius:8px;border-left:4px solid var(--wp--preset--color--primary-green);padding:var(--wp--preset--spacing--30)">
				...
				<!-- /wp:heading -->
				<!-- wp:paragraph {"style":{"color":{"text":"#555555"}}} -->
				<p style="color:#555555">예술을 통해 스스로 이끌어가는 리더십을 갖춘 발달장애 예술 지도자를 양성합니다.</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<!-- wp:heading {"level":3,"style":{"color":{"text":"var:preset|color|deep-navy"},"typography":{"fontSize":"var:preset|font-size|x-large","fontWeight":"600"},"spacing":{"margin":{"bottom":"var:preset|spacing|30"}}}} -->
	<h3 class="wp-block-heading" style="color:var(--wp--preset--color--deep-navy);font-size:var(--wp--preset--font-size--x-large);font-weight:600;margin-bottom:var(--wp--preset--spacing--30)">더 알아보기</h3>
	<!-- /wp:heading -->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/lahaph/purpose" style="border-radius:6px;border-color:var(--wp--preset--color--deep-navy);color:var(--wp--preset--color--deep-navy)">설립 목적</a></div>
		<!-- /wp:button -->
		<!-- wp:button {"className":"is-style-outline","style":{"border":{"radius":"6px","color":"var:preset|color|deep-navy","width":"1px"},"color":{"text":"var:preset|color|deep-navy"}}} -->
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/lahaph/history" style="border-radius:6px;border-color:var(--wp--preset--color--deep-navy);color:var(--wp--preset--color--deep-navy)">연혁</a></div>
		<!-- /wp:button -->
		<!-- wp:button {"className":"is-style-outline","style":{"border":{"radius":"6px","color":"var:preset|color|deep-navy","width":"1px"},"color":{"text":"var:preset|color|deep-navy"}}} -->
		<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/members" style="border-radius:6px;border-color:var(--wp--preset--color--deep-navy);color:var(--wp--preset--color--deep-navy)">Members</a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
...
<div class="wp-block-group" style="padding-bottom:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group lahaph-cta" style="background-color:#F0FAF0;padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);border-radius:8px">
		...
		<p class="has-text-align-center" style="color:#444444;font-size:var(--wp--preset--font-size--large)">프로그램 참여나 후원, 협력에 관한 문의를 남겨주세요.</p>
		<!-- /wp:paragraph -->
