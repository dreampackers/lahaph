			...
			'params' => array( 
				...
				array( 'param_name' => 'top_spacing', 'type' => 'dropdown', 'heading' => esc_html__( 'Top spacing', 'tabula' ), 'preview' => true,
					 'responsive_override' => true, 'value' => array(
						esc_html__( 'No spacing', 'tabula' ) 		=> 'none',
				...
				array( 'param_name' => 'show_video_on_mobile',  'type' => 'checkbox', 'value' => array( esc_html__( 'Yes', 'tabula' ) => 'yes' ), 'default' => '', 'heading' => esc_html__( 'Show Video on Mobile Devices', 'tabula' ), 'group' => esc_html__( 'Video', 'tabula' ) )
			)
		) );
	} 
}
